...
async function nestedCall() {
    ...
    console.log('Transaction Count including pending:' + nonce.result)
    ...
    //const receipt2 = await customWeb3Request(web3.currentProvider, "eth_getTransactionCount", [account]);
    //console.log('count without pending tx:' + receipt2.result)
 
    //const receipt3 = await customWeb3Request(web3.currentProvider, "eth_getTransactionCount", [account, 'pending']);
    //console.log('count with pending tx:' + receipt3.result)
